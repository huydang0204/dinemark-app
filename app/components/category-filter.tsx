  ...
  return (
    <div className="w-full mb-6 flex space-x-4 overflow-x-auto pb-2">
      {Object.values(STORE_CATEGORY).map((category) => {
        ...
        let defaultStyle =
          "bg-gray-200 rounded-full text-sm whitespace-nowrap hover:bg-blue-500 hover:text-white";
        if (currentlySelected) {
          defaultStyle =
            "bg-blue-500 text-white rounded-full text-sm whitespace-nowrap";
        }
        ...
        return (
          <button
            ...
            onClick={() => {
              onCategoryChange(currentlySelected ? "" : category);
            }}
          >
